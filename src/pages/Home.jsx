...
const Home = () => {
  ...
  const items = [
    {
      ...
      content:
        "X-Log  an online pharmacy aggregator platform that aggregates different registered retail pharmacies for easy access to those pharmacies and also helps to deliver the medicines that you need.",
    },
    {
      name: "How else can I Place an order outside this website?",
      content:
        "Asides placing your order on the website, you can also place your order by sending an email to joshuaokorie008@gmail.com or a message on Whatsapp to this number - 08148429444.",
    },
    {
  ...
  return (
    <>
      ...
      >
        <SwiperSlide>
          <img className="min-h-full" src={slide1} alt="" />
        </SwiperSlide>
        <SwiperSlide>
          <img className=" min-h-full" src={slide2} alt="" />
        </SwiperSlide>
        <SwiperSlide>
          <img className=" min-h-full" src={slide3} alt="" />
        </SwiperSlide>
        <SwiperSlide>
          <img className=" min-h-full" src={slide4} alt="" />
        </SwiperSlide>
        <SwiperSlide>
          <img className=" min-h-full" src={slide5} alt="" />
        </SwiperSlide>
      </Swiper>
      ...
      <section className=" my-5">
        <div className=" flex items-center my-5">
          <p className=" ml-5 text-2xl text-blue-500 font-medium">
            Featured products
          </p>
          ...
          <div className=" ml-auto flex gap-4 mr-5">
            <button
              onClick={prevProduct}
              className=" p-1 rounded bg-slate-300 hover:bg-slate-400 text-lg"
            >
              <GrPrevious />
            </button>
            <button
        ...
        <div
          ref={slideProductRef}
          className=" scroll-smooth transition-all flex gap-5 overflow-scroll scrollbar-none"
        >
          {isLoading ? (
        ...
        <div className=" mt-8  mx-auto flex flex-col items-center">
          <button className=" border py-2 px-6 border-black text-base rounded-md hover:bg-blue-500 duration-300 hover:text-white ">
            <Link
        ...
        >
          <SwiperSlide>
            <div className=" h-52 text-black bg-slate-100  flex flex-col items-center justify-center w-4/5 sm:w-3/6 mx-auto p-3 rounded-lg drop-shadow-lg m-5">
              ...
              <p className=" text-sm text-center">X-log is next to none❤</p>
          ...
          <SwiperSlide>
            <div className=" h-52 text-black bg-slate-100   flex flex-col items-center justify-center w-4/5 sm:w-3/6 mx-auto p-3 rounded-lg drop-shadow-lg m-5">
              ...
              <p className=" text-sm text-center">
                X-log is a very reliable e-pharmacy outlet. I fully trust depend
                for quick delivery of my medical supplies.
              </p>
          ...
          <SwiperSlide>
            <div className="h-52 text-black bg-slate-100 flex flex-col items-center justify-center w-4/5 sm:w-3/6 mx-auto p-3 rounded-lg drop-shadow-lg m-5">
              ...
              <p className=" text-sm text-center">
                X-log is a very reliable e-pharmacy outlet. I fully trust and
                depend on them for quick delivery of my medical supplies.
              </p>
      ...
      <section className=" w-4/5 md:w-3/5 mx-auto mt-10">
        <p className=" my-5 capitalize text-xl md:text-3xl font-medium">
      ...
      <section className=" w-4/5 bg-slate-100 text-black rounded-lg mx-auto mt-10 p-2 md:p-5">
        <div className=" flex md:flex-row flex-col  gap-6 md:items-center md:justify-between p-5">
          <div>
            ...
            <p className=" text-sm ">
              Get the latest blog and updates delivered straight to your inbox
            </p>
          </div>
          <form
            onSubmit={handleSubmit}
            className=" md:flex md:justify-between  md:basis-3/5"
          >
            <input
              required
              type="email"
              ...
              className=" p-2 outline-none md:w-5/6 mr-5 w-full"
            />
            <button className="md:mt-0 mt-3 p-2 text-white bg-blue-500 text-sm rounded-md">
